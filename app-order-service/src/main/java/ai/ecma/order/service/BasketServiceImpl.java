...
public class BasketServiceImpl implements BasketService {
    ...
    @Override
    @Transactional
    public ApiResult<BasketRespDto> incrementProduct(UUID productId, Integer quantity) {
        ...
        if (optionalBasket.isEmpty()) {
            basket = Order.builder()
                    ...
                    .setTotalSum(product.getPrice() * quantity)
                    .build();

        } else {
            basket = optionalBasket.get();
            basket.setTotalSum(basket.getTotalSum() + (product.getPrice() * quantity));
        }
        ...
        if (optionalOrderProduct.isEmpty()) {
            orderProduct = new OrderProduct(quantity, product.getPrice(), basket, product);
        } else {
