...
public interface OrderRepository extends JpaRepository<Order, UUID> {
    ...
    @Query(nativeQuery = true, value = "select orders.* from orders join users u on orders.client_id = u.id\n" +
            "where u.telegram_id =:telegramId and orders.status = 'BASKET'")
    Optional<Order> findFirstByStatusAndClient_TelegramId(@Param("telegramId") Long telegramId);
